 ...
 */
int game_info_validate(game_info_t *gi, char *gameId, char *pebbleId,
 ...
 */
int game_info_krag_distance(game_info_t *gi, char *kragId,
 ...
 * Return NULL if it does not exist
 */
team_t *game_info_find_team_pebbleId(game_info_t *gi, char *pebbleId);

/* Send message to all agents in the game
 */
void game_info_send_message_to_everyone(game_info_t *gi, char *message,
        int comm_sock, void (*itemfunc)(void *arg, const char *key, void *item));
 ...
 */
int team_register_fa(game_info_t *gi, team_t *team,
        char *pebbleId, char *player_name, struct sockaddr_in them,
        char *latitude, char *longitude);
 ...
 */
int team_register_ga(game_info_t *gi, team_t *team,
            char *guideId, char *player_name, struct sockaddr_in them);

/* Send GS_AGENT to guide agent
 */
void team_send_gs_agent(game_info_t *gi, team_t *team,
            int comm_sock, void (*itemfunc)(void *arg, const char *key, void *item));
